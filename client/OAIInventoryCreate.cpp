...
OAIInventoryCreate::OAIInventoryCreate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInventoryCreate::OAIInventoryCreate() {
    this->initializeModel();
}

OAIInventoryCreate::~OAIInventoryCreate() {}

void OAIInventoryCreate::initializeModel() {
...
void OAIInventoryCreate::fromJson(QString jsonString) {
...
void OAIInventoryCreate::fromJsonObject(QJsonObject json) {
...
QString OAIInventoryCreate::asJson() const {
...
QJsonObject OAIInventoryCreate::asJsonObject() const {
    QJsonObject obj;
    if (m_quantity_isSet) {
...
double OAIInventoryCreate::getQuantity() const {
    return m_quantity;
}
void OAIInventoryCreate::setQuantity(const double &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIInventoryCreate::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIInventoryCreate::is_quantity_Valid() const{
    return m_quantity_isValid;
}

double OAIInventoryCreate::getReservedQuantity() const {
    return m_reserved_quantity;
}
void OAIInventoryCreate::setReservedQuantity(const double &reserved_quantity) {
    m_reserved_quantity = reserved_quantity;
    m_reserved_quantity_isSet = true;
}

bool OAIInventoryCreate::is_reserved_quantity_Set() const{
    return m_reserved_quantity_isSet;
}

bool OAIInventoryCreate::is_reserved_quantity_Valid() const{
    return m_reserved_quantity_isValid;
}

QString OAIInventoryCreate::getStorageLocation() const {
    return m_storage_location;
}
void OAIInventoryCreate::setStorageLocation(const QString &storage_location) {
    m_storage_location = storage_location;
    m_storage_location_isSet = true;
}

bool OAIInventoryCreate::is_storage_location_Set() const{
    return m_storage_location_isSet;
}

bool OAIInventoryCreate::is_storage_location_Valid() const{
    return m_storage_location_isValid;
}

QString OAIInventoryCreate::getBatchNumber() const {
    return m_batch_number;
}
void OAIInventoryCreate::setBatchNumber(const QString &batch_number) {
    m_batch_number = batch_number;
    m_batch_number_isSet = true;
}

bool OAIInventoryCreate::is_batch_number_Set() const{
    return m_batch_number_isSet;
}

bool OAIInventoryCreate::is_batch_number_Valid() const{
    return m_batch_number_isValid;
}

bool OAIInventoryCreate::isSet() const {
...
bool OAIInventoryCreate::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_storage_location_isValid && m_batch_number_isValid && true;
}
