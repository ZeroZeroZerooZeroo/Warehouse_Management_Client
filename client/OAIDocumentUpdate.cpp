...
QString OAIDocumentUpdate::getDocumentNumber() const {
    return m_document_number;
}
void OAIDocumentUpdate::setDocumentNumber(const QString &document_number) {
    m_document_number = document_number;
    m_document_number_isSet = true;
}

bool OAIDocumentUpdate::is_document_number_Set() const{
    return m_document_number_isSet;
}

bool OAIDocumentUpdate::is_document_number_Valid() const{
    return m_document_number_isValid;
}

QString OAIDocumentUpdate::getStatus() const {
    return m_status;
}
void OAIDocumentUpdate::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDocumentUpdate::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDocumentUpdate::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIDocumentUpdate::getComments() const {
    return m_comments;
}
void OAIDocumentUpdate::setComments(const QString &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAIDocumentUpdate::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAIDocumentUpdate::is_comments_Valid() const{
    return m_comments_isValid;
}

qint64 OAIDocumentUpdate::getCustomerId() const {
    return m_customer_id;
}
void OAIDocumentUpdate::setCustomerId(const qint64 &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAIDocumentUpdate::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAIDocumentUpdate::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

qint64 OAIDocumentUpdate::getItemId() const {
    return m_item_id;
}
void OAIDocumentUpdate::setItemId(const qint64 &item_id) {
    m_item_id = item_id;
    m_item_id_isSet = true;
}

bool OAIDocumentUpdate::is_item_id_Set() const{
    return m_item_id_isSet;
}

bool OAIDocumentUpdate::is_item_id_Valid() const{
    return m_item_id_isValid;
}

qint64 OAIDocumentUpdate::getMovementId() const {
    return m_movement_id;
}
void OAIDocumentUpdate::setMovementId(const qint64 &movement_id) {
    m_movement_id = movement_id;
    m_movement_id_isSet = true;
}

bool OAIDocumentUpdate::is_movement_id_Set() const{
    return m_movement_id_isSet;
}

bool OAIDocumentUpdate::is_movement_id_Valid() const{
    return m_movement_id_isValid;
}

qint64 OAIDocumentUpdate::getMovementTypeId() const {
    return m_movement_type_id;
}
void OAIDocumentUpdate::setMovementTypeId(const qint64 &movement_type_id) {
    m_movement_type_id = movement_type_id;
    m_movement_type_id_isSet = true;
}

bool OAIDocumentUpdate::is_movement_type_id_Set() const{
    return m_movement_type_id_isSet;
}

bool OAIDocumentUpdate::is_movement_type_id_Valid() const{
