...
#ifndef OAIStockMovement_H
#define OAIStockMovement_H
...
class OAIStockMovement : public OAIObject {
public:
    OAIStockMovement();
    OAIStockMovement(QString json);
    ~OAIStockMovement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStockMovement)

#endif // OAIStockMovement_H
