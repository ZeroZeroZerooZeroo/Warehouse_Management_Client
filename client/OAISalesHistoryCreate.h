...
/*
 * OAISalesHistoryCreate.h
 *
 * 
 */

#ifndef OAISalesHistoryCreate_H
#define OAISalesHistoryCreate_H
...
class OAISalesHistoryCreate : public OAIObject {
public:
    OAISalesHistoryCreate();
    OAISalesHistoryCreate(QString json);
    ~OAISalesHistoryCreate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISalesHistoryCreate)

#endif // OAISalesHistoryCreate_H
