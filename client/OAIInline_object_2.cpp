...
QString OAIInline_object_2::getMessage() const {
    return m_message;
}
void OAIInline_object_2::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIInline_object_2::is_message_Set() const{
    return m_message_isSet;
}

bool OAIInline_object_2::is_message_Valid() const{
