...
qint64 OAIDocument::getDocumentId() const {
    return m_document_id;
}
void OAIDocument::setDocumentId(const qint64 &document_id) {
...
qint64 OAIDocument::getTypeId() const {
    return m_type_id;
}
void OAIDocument::setTypeId(const qint64 &type_id) {
    m_type_id = type_id;
    m_type_id_isSet = true;
}

bool OAIDocument::is_type_id_Set() const{
    return m_type_id_isSet;
}

bool OAIDocument::is_type_id_Valid() const{
    return m_type_id_isValid;
}

qint64 OAIDocument::getDocumentStatusId() const {
    return m_document_status_id;
}
void OAIDocument::setDocumentStatusId(const qint64 &document_status_id) {
    m_document_status_id = document_status_id;
    m_document_status_id_isSet = true;
}

bool OAIDocument::is_document_status_id_Set() const{
    return m_document_status_id_isSet;
}

bool OAIDocument::is_document_status_id_Valid() const{
    return m_document_status_id_isValid;
}

QString OAIDocument::getDocumentNumber() const {
    return m_document_number;
}
void OAIDocument::setDocumentNumber(const QString &document_number) {
    m_document_number = document_number;
    m_document_number_isSet = true;
}

bool OAIDocument::is_document_number_Set() const{
    return m_document_number_isSet;
}

bool OAIDocument::is_document_number_Valid() const{
    return m_document_number_isValid;
}

QDateTime OAIDocument::getCreatedDate() const {
    return m_created_date;
}
void OAIDocument::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIDocument::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIDocument::is_created_date_Valid() const{
...
QString OAIDocument::getComments() const {
    return m_comments;
}
void OAIDocument::setComments(const QString &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAIDocument::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAIDocument::is_comments_Valid() const{
    return m_comments_isValid;
}

qint64 OAIDocument::getCustomerId() const {
    return m_customer_id;
}
void OAIDocument::setCustomerId(const qint64 &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAIDocument::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAIDocument::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

qint64 OAIDocument::getItemId() const {
    return m_item_id;
}
void OAIDocument::setItemId(const qint64 &item_id) {
    m_item_id = item_id;
    m_item_id_isSet = true;
}

bool OAIDocument::is_item_id_Set() const{
    return m_item_id_isSet;
}

bool OAIDocument::is_item_id_Valid() const{
    return m_item_id_isValid;
}

qint64 OAIDocument::getMovementId() const {
    return m_movement_id;
}
void OAIDocument::setMovementId(const qint64 &movement_id) {
    m_movement_id = movement_id;
    m_movement_id_isSet = true;
}

bool OAIDocument::is_movement_id_Set() const{
    return m_movement_id_isSet;
}

bool OAIDocument::is_movement_id_Valid() const{
    return m_movement_id_isValid;
}

qint64 OAIDocument::getMovementTypeId() const {
    return m_movement_type_id;
}
void OAIDocument::setMovementTypeId(const qint64 &movement_type_id) {
    m_movement_type_id = movement_type_id;
    m_movement_type_id_isSet = true;
}

bool OAIDocument::is_movement_type_id_Set() const{
    return m_movement_type_id_isSet;
}

bool OAIDocument::is_movement_type_id_Valid() const{
...
bool OAIDocument::isValid() const {
    ...
    return m_document_id_isValid && m_type_id_isValid && m_document_status_id_isValid && m_document_number_isValid && m_created_date_isValid && m_status_isValid && m_customer_id_isValid && true;
}
