...
/*
 * OAIUserProfileUpdate.h
 *
 * 
 */

#ifndef OAIUserProfileUpdate_H
#define OAIUserProfileUpdate_H
...
class OAIUserProfileUpdate : public OAIObject {
public:
    OAIUserProfileUpdate();
    OAIUserProfileUpdate(QString json);
    ~OAIUserProfileUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserProfileUpdate)

#endif // OAIUserProfileUpdate_H
