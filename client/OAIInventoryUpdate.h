...
/*
 * OAIInventoryUpdate.h
 *
 * 
 */

#ifndef OAIInventoryUpdate_H
#define OAIInventoryUpdate_H
...
class OAIInventoryUpdate : public OAIObject {
public:
    OAIInventoryUpdate();
    OAIInventoryUpdate(QString json);
    ~OAIInventoryUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInventoryUpdate)

#endif // OAIInventoryUpdate_H
