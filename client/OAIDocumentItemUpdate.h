...
/*
 * OAIDocumentItemUpdate.h
 *
 * 
 */

#ifndef OAIDocumentItemUpdate_H
#define OAIDocumentItemUpdate_H
...
class OAIDocumentItemUpdate : public OAIObject {
public:
    OAIDocumentItemUpdate();
    OAIDocumentItemUpdate(QString json);
    ~OAIDocumentItemUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentItemUpdate)

#endif // OAIDocumentItemUpdate_H
