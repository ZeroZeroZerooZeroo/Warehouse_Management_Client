...
OAIDemandForecastUpdate::OAIDemandForecastUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDemandForecastUpdate::OAIDemandForecastUpdate() {
    this->initializeModel();
}

OAIDemandForecastUpdate::~OAIDemandForecastUpdate() {}

void OAIDemandForecastUpdate::initializeModel() {
...
void OAIDemandForecastUpdate::fromJson(QString jsonString) {
...
void OAIDemandForecastUpdate::fromJsonObject(QJsonObject json) {
...
QString OAIDemandForecastUpdate::asJson() const {
...
QJsonObject OAIDemandForecastUpdate::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIDemandForecastUpdate::getForecastDate() const {
    return m_forecast_date;
}
void OAIDemandForecastUpdate::setForecastDate(const QDateTime &forecast_date) {
    m_forecast_date = forecast_date;
    m_forecast_date_isSet = true;
}

bool OAIDemandForecastUpdate::is_forecast_date_Set() const{
    return m_forecast_date_isSet;
}

bool OAIDemandForecastUpdate::is_forecast_date_Valid() const{
    return m_forecast_date_isValid;
}

QDate OAIDemandForecastUpdate::getPeriodStart() const {
    return m_period_start;
}
void OAIDemandForecastUpdate::setPeriodStart(const QDate &period_start) {
    m_period_start = period_start;
    m_period_start_isSet = true;
}

bool OAIDemandForecastUpdate::is_period_start_Set() const{
    return m_period_start_isSet;
}

bool OAIDemandForecastUpdate::is_period_start_Valid() const{
    return m_period_start_isValid;
}

QDate OAIDemandForecastUpdate::getPeriodEnd() const {
    return m_period_end;
}
void OAIDemandForecastUpdate::setPeriodEnd(const QDate &period_end) {
    m_period_end = period_end;
    m_period_end_isSet = true;
}

bool OAIDemandForecastUpdate::is_period_end_Set() const{
    return m_period_end_isSet;
}

bool OAIDemandForecastUpdate::is_period_end_Valid() const{
    return m_period_end_isValid;
}

double OAIDemandForecastUpdate::getPredictedQuantity() const {
    return m_predicted_quantity;
}
void OAIDemandForecastUpdate::setPredictedQuantity(const double &predicted_quantity) {
    m_predicted_quantity = predicted_quantity;
    m_predicted_quantity_isSet = true;
}

bool OAIDemandForecastUpdate::is_predicted_quantity_Set() const{
    return m_predicted_quantity_isSet;
}

bool OAIDemandForecastUpdate::is_predicted_quantity_Valid() const{
    return m_predicted_quantity_isValid;
}

qint64 OAIDemandForecastUpdate::getRecordId() const {
    return m_record_id;
}
void OAIDemandForecastUpdate::setRecordId(const qint64 &record_id) {
    m_record_id = record_id;
    m_record_id_isSet = true;
}

bool OAIDemandForecastUpdate::is_record_id_Set() const{
    return m_record_id_isSet;
}

bool OAIDemandForecastUpdate::is_record_id_Valid() const{
    return m_record_id_isValid;
}

bool OAIDemandForecastUpdate::isSet() const {
...
bool OAIDemandForecastUpdate::isValid() const {
